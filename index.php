...
<div class="bg-blue-100 rounded-lg p-6 mb-8 shadow-md">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
    ...
    <a href="https://oedigob-my.sharepoint.com/:w:/g/personal/tecnologia_oedi_gob_pe/EbQhKpOgqMZNtbMRdTzrgH0BsbO3InaYXk93FJ96aFMpQQ?e=JQs6sy" target="_blank" class="text-blue-600 hover:text-blue-800 hover:underline transition-colors duration-200">ANEXO 2 CAS</a>
  ...
  <div class="accordion-item bg-white rounded-lg shadow-md overflow-hidden">
    <div class="accordion-header bg-blue-700 text-white p-4 flex justify-between items-center cursor-pointer">
      <div>
        ...
        <p class="text-sm text-blue-100">Fecha de publicación: <?php echo $convocatoria['fecha_publicacion']; ?>
